...
import { Bell, Search, RefreshCw, Anchor, Globe, Shield, MapPin, Phone, Mail } from "lucide-react";
      ...
      <div className="flex items-center gap-6 relative z-10">
        ...
        <div className="flex items-center gap-1.5 border-l border-slate-800/80 pl-4">
          <button 
            ...
            className="flex items-center gap-1.5 p-2 rounded-xl text-slate-400 hover:text-slate-200 hover:bg-white/5 transition-all cursor-pointer border border-transparent hover:border-slate-800 mr-2"
          >
          ...
          <button 
            ...
            className="p-2.5 rounded-xl text-slate-400 hover:text-slate-200 hover:bg-white/5 transition-colors cursor-pointer border border-transparent hover:border-slate-800"
          >
            <RefreshCw className="h-4 w-4" />
          </button>

          <button 
            title={language === "es" ? "Alertas de Recepción" : "Reception Alerts"}
            className="relative p-2.5 rounded-xl text-slate-400 hover:text-slate-200 hover:bg-white/5 transition-colors cursor-pointer border border-transparent hover:border-slate-800"
          >
